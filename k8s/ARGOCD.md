...
`k8s/argocd/applicationset.yaml` uses the **List generator** to template out both environments from one manifest:
...
```
devops-info-service-set-dev    dev
devops-info-service-set-prod   prod
```
